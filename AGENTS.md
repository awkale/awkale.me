...
| `docs/archive/program-19930726-liyo-dallas-brooks-hall.jpg` | Photographed printed program, Long Island Youth Orchestra at Dallas Brooks Hall, Melbourne, 1993-07-26. **A primary source for a concert no other source here holds** — not in the xlsx, not in `bso-graph.json`. Its **orchestra now exists** (`236YCHXmB2L4Dmz8qF8CSF`, created by hand under AWK-59); its hall and conductors still do not. Untranscribed, and blocked on AWK-59's institution-scoped Season. |
