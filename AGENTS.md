...
> **Run the command.**
>
> **582 across twenty-six** as of 2026-08-31, AWK-64 contributing 32 in
> `tilles-center-programs.test.ts`. Recorded only because the gap from 321 was
...
>
> Those figures are AWK-39's. The sweep answered **127 concerts · 346 works · 156
> composers · 0 projects, from 406 qualifying pairs — 635 paths** on 2026-08-31,
> after AWK-64. The arithmetic is worth knowing because it is the fastest check
> that a transcription landed whole: 6 static plus the three routed counts is the
> path total exactly, so 6 + 127 + 346 + 156 = 635. Count it, do not read it.
>
