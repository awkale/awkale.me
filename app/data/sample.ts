...
export const CONCERTS: Concert[] = [
  {
    ...
    orchestra: "BSO",
    program: [
      { order: 1, composer: "Beethoven, Ludwig van", arranger: null, work: "Coriolan Overture", workSlug: "coriolan-overture" },
      { order: 2, composer: "Elgar, Edward", arranger: null, work: "Cello Concerto in A Minor", workSlug: "cello-concerto-in-a-minor" },
      { order: 3, composer: "Dvorak, Antonin", arranger: null, work: "Symphony No. 8 in G Major", workSlug: "symphony-no-8-in-g-major" },
    ],
  },
  {
    date: "2019-12-15",
    ...
    program: [
      ...
      { order: 2, composer: "Prokofiev, Sergei", arranger: null, work: "Peter and the Wolf", workSlug: "peter-and-the-wolf" },
      { order: 3, composer: "Tchaikovsky, Pyotr Ilyich", arranger: null, work: "The Nutcracker Suite", workSlug: "the-nutcracker-suite" },
      { order: 4, composer: "Tchaikovsky, Pyotr Ilyich", arranger: "Ellington", work: "The Nutcracker Suite", workSlug: "the-nutcracker-suite-ellington" },
      { order: 5, composer: "Strauss, Johann II", arranger: null, work: "Perpetuum Mobile", workSlug: "perpetuum-mobile" },
  ...
  },
  {
    ...
    program: [
      ...
      { order: 2, composer: "Mendelssohn, Felix", arranger: null, work: 'Symphony No. 3 in A Minor ("Scottish")', workSlug: "symphony-no-3-in-a-minor-scottish" },
    ],
  },
];
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    years: "2026",
    summary:
      "This site. Prerendered React over Contentful, with an indexed history of every concert I have played.",
